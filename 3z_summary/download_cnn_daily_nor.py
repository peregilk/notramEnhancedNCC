...
def main():
    parser = argparse.ArgumentParser(description="Download cnn_daily_mail_nor_final and save train split as JSONL (fields trimmed).")
    parser.add_argument('--output_file', required=True, help='Output JSONL file')
    args = parser.parse_args()

    dataset = load_dataset("navjordj/cnn_daily_mail_nor_final", split="train")
